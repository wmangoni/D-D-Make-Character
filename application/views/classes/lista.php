    ...
    <table class="table table-striped table-bordered table-list">
      ...
      <tbody>
        <?php foreach($classes as $key => $classe) : ?>
          <tr>
            <td align="center">
              <a href="<?php echo base_url('classes/edit').'/'.$classe->id; ?>" class="btn btn-success"><em class="fa fa-pencil"></em></a>
              <a href="<?php echo base_url('classes/drop').'/'.$classe->id ?>" class="btn btn-danger"><em class="fa fa-trash"></em></a>
            </td>
